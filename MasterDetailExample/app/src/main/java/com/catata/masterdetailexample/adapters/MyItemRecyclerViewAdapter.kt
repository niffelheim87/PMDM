package com.catata.masterdetailexample.adapters
...
import com.catata.masterdetailexample.databinding.ListItemBinding
...
class MyItemRecyclerViewAdapter(
    ...
    override fun getItemViewType(pos: Int): Int {
        return if (superHeroList[pos].id <= 10) 0 else 1
    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        //We are using an extension toBitmap
        //holder.ivPoster.setImageBitmap(superhero.photo.toBitmap(holder.ivPoster.context))

        holder.ivPoster.setBitmapfromString(superhero.photo)
